...
describe('Evaluation of Medium mounting', () => {
...
describe('Evaluation of Medium creation', () => {
  const createdMock = jest.fn();
...
describe('Evaluation of Medium unmounting', () => {
...
describe('Evaluation of Medium destruction', () => {
  const destroyedMock = jest.fn();
...
describe('Evaluation of Medium listener registration', () => {
  const params = {
    seanceOrigin
  };
...
describe('Evaluation of Medium listener cleanup', () => {
  const params = {
    seanceOrigin
  };
