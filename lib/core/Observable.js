...
class Observable {
  ...
  recv (message) {
    ...
    // this is neither a request for incorporation nor a request from a known client; return
    if (!this.observatory.has(origin) && type !== EVENT_TYPES.MOUNT) return; // TODO permissions
